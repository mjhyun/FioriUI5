		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD] 가격 관리 프로그램",
									"targetURL": "#zbacustomermanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbacustomermanager-display": {
								"semanticObject": "zbacustomermanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbacustomermanager",
									"url": sap.ui.require.toUrl("zbacustomermanager")
								}
							}
						}
					}
