		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD] 가격 관리 프로그램",
									"targetURL": "#zbapricemanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbapricemanager-display": {
								"semanticObject": "zbapricemanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbapricemanager",
									"url": sap.ui.require.toUrl("zbapricemanager")
								}
							}
						}
					}
