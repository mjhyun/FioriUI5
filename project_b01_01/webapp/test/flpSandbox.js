		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title for Test",
									"targetURL": "#projectb0101-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb0101-display": {
								"semanticObject": "projectb0101",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb0101",
									"url": sap.ui.require.toUrl("projectb0101")
								}
							}
						}
					}
