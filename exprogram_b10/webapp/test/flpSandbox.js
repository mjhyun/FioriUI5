		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공편 조회 (B10)",
									"targetURL": "#examexprogramb10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogramb10-display": {
								"semanticObject": "examexprogramb10",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogramb10",
									"url": sap.ui.require.toUrl("exam/exprogramb10")
								}
							}
						}
					}
