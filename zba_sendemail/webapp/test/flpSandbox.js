		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[FIYURI-SD] 대금청구서 이메일 발송",
									"targetURL": "#zbasendemail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbasendemail-display": {
								"semanticObject": "zbasendemail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbasendemail",
									"url": sap.ui.require.toUrl("zbasendemail")
								}
							}
						}
					}
