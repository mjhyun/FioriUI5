		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Member",
									"targetURL": "#zprojectb1008-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectb1008-display": {
								"semanticObject": "zprojectb1008",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectb1008",
									"url": sap.ui.require.toUrl("zprojectb1008")
								}
							}
						}
					}
