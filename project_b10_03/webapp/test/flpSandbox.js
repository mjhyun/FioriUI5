		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FioriApp3",
									"targetURL": "#projectb1003-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb1003-display": {
								"semanticObject": "projectb1003",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb1003",
									"url": sap.ui.require.toUrl("projectb1003")
								}
							}
						}
					}
