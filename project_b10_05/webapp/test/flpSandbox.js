		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FioriExample5",
									"targetURL": "#projectb1005-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb1005-display": {
								"semanticObject": "projectb1005",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb1005",
									"url": sap.ui.require.toUrl("projectb1005")
								}
							}
						}
					}
