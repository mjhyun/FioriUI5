		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD",
									"targetURL": "#odatacrudb10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odatacrudb10-display": {
								"semanticObject": "odatacrudb10",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odatacrudb10",
									"url": sap.ui.require.toUrl("odatacrudb10")
								}
							}
						}
					}
